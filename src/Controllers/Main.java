...
//        Parent root = FXMLLoader.load(getClass().getResource("/Views/frmLogin.fxml"));
        ...
        //Font.loadFont(getClass().getClassLoader().getResource("Assets.Fonts/SriBhashitha.ttf").toExternalForm(), 15);
        //mainScene.getStylesheets().add(getClass().getClassLoader().getResource("Assets.CSS/Decorator.css").toExternalForm());
        primaryStage.setScene(mainScene);
        primaryStage.initStyle(StageStyle.UTILITY);
        primaryStage.setResizable(false);
        primaryStage.getIcons().add(new Image("Assets/Graphics/Main_01.png"));
