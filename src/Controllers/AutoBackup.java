...
public class AutoBackup {
    ...
    private void getBackUp(String backup_path, File file) {

        String mgsSuccess = "Database backup successful.";
...
//            }*/
        ...
        String command = " " + dumppath + " -u" + username + " -p" + password + " --add-drop-database --routines --events --triggers -B " + database + " -r " + "\"" + backup_path + "\\" + strFilename + ".sql\"";
        Process p = null;
        try {
            ...
            if (processComplete == 0) {
                if (count > 0) {
                    Platform.runLater(() -> {
                        ///notifications.show();
                        alerts.getSuccessNotify("Database Backup", mgsSuccess);
                    });
                }
                count = 1;
                //fileCount++;
